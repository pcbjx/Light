...
public class MyToolBar extends RelativeLayout {
	...
	public void updateRightButton(int bt_status)
	{
		...
		if (bt_status== 0) {
			setToolBarRightBtnText(R.string.connect_status_connect);
		}
		if (bt_status == 1) {
			setToolBarRightBtnText(R.string.connect_status_ing);
		}
		if (bt_status == 2) {
			setToolBarRightBtnText(R.string.connect_status_dis);
		}
	}
